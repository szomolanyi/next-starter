const SocialLoginButtons = () => (
  <div className="buttons">
    ...
    <a className="button is-fullwidth" href={`${process.env.NEXT_PUBLIC_SERVER_URL}/auth/facebook`}>
      <span className="icon">
        <svg width="25" height="25" fill="#3B5998">
          <path d="M20.3 4H4.7a.7.7 0 0 0-.7.7v15.6c0 .38.32.7.7.7h8.33v-6.38h-2.12v-2.65h2.12V9.84c0-2.2 1.4-3.27 3.35-3.27.94 0 1.75.07 1.98.1v2.3H17c-1.06 0-1.31.5-1.31 1.24v1.76h2.65l-.53 2.65H15.7l.04 6.38h4.56a.7.7 0 0 0 .71-.7V4.7a.7.7 0 0 0-.7-.7" fillRule="evenodd" />
        </svg>
      </span>

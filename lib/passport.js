...
passport.use(new GoogleStrategy({
  clientID: "465519336043-h1nl3pr5f4rs863aic3chdslvc08jooa.apps.googleusercontent.com",
  clientSecret: "k3tQyA6j4FYU5zENvZYhSMdO",
...
async (request, accessToken, refreshToken, profile, done) => {
  ...
  try {
    ...
    */
    ...
    console.log({ m: "======use GoogleStrategy error======", error })
  ...
  User.findOneAndUpdate(
    { email: profile.email },
    { 
      isVerified: true, // verified by Google; TODO: this is not safe, identity steel is possible
      firstName: profile.given_name,
      lastName: profile.family_name,
      google: profile,
    },
